...
function getAveragePrices(closingPricesForAllStocks) {
  let sum =
    closingPricesForAllStocks[0] +
    closingPricesForAllStocks[1] +
    closingPricesForAllStocks[2] +
    closingPricesForAllStocks[3] +
    closingPricesForAllStocks[4];
  let average = sum / 5;
...
function getPriceChanges(closingPricesForAllStocks) {
  ...
  for (let pricesForOneStock of closingPricesForAllStocks) {
    let change = getAveragePrices(pricesForOneStock);
    changes.push(change);
  }
