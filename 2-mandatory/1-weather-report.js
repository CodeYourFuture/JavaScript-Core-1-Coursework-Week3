/*
    ...
    We also already have a temperatureService function which will take a city as a parameter and 
    return a temparature.
...
function getTemperatureReport(cities) {
    // TODO
  let allCityTemperature = [];
  for (const city of cities) {
    let cityTemperature = temperatureService(city);
    allCityTemperature.push(
      `The temperature in ${city} is ${cityTemperature} degrees`
    );
  }
  return allCityTemperature;*/
