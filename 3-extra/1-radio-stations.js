...
// function getAllFrequencies(frequencie){
  ...
  // ];
//   let radioFrequencie=[];
// for(i= 0; i> frequencie.length; i++){
//    if(frequencie[i] >=78 && frequencie[i].length <= 108){
//  let station = frequencie[i]; 
//  radioFrequencie.push(station);
// }
// }
