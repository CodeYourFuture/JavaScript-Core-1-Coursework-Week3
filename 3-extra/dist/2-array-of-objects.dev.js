...
function getHighestRatedInEachGenre(books) {
  ...
  books.forEach(function (book) {
    if (!genreArr.includes(book.genre)) {
      genreArr.push(book.genre);
...
test("should return the highest rated book in each genre", function () {
  expect(new Set(getHighestRatedInEachGenre(BOOKS))).toEqual(new Set(["The Book Your Dog Wishes You Would Read", "Gangsta Granny Strikes Again!", "Dishoom: The first ever cookbook from the much-loved Indian restaurant"]));
});