...
function getHighestRatedInEachGenre(books) {
    ...
    for (let eachBook of books) {
        if (ratesOfBook[eachBook.genre] === undefined || ratesOfBook[eachBook.genre].rating < eachBook.rating) {
            ratesOfBook[eachBook.genre] = eachBook;
        }
    }
    return Object.values(ratesOfBook).map(book => book.title);
}
